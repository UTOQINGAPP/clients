...
import 'package:clients_client/src/protocol/cliente.dart' as _i4;
export 'cliente.dart';
export 'example.dart';
export 'client.dart';
...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    t ??= T;
    if (t == _i2.Cliente) {
      return _i2.Cliente.fromJson(data) as T;
    }
    if (t == _i3.Example) {
      return _i3.Example.fromJson(data) as T;
    }
    if (t == _i1.getType<_i2.Cliente?>()) {
      return (data != null ? _i2.Cliente.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i3.Example?>()) {
      return (data != null ? _i3.Example.fromJson(data) : null) as T;
    }
    if (t == List<_i4.Cliente>) {
      return (data as List).map((e) => deserialize<_i4.Cliente>(e)).toList()
          as dynamic;
    }
